...
namespace FGD
{
    ...
    struct SizeAttribute : public Attribute
    {
        ...
        SizeAttribute(int a, int b, int c)
        : bbox1{a, b, c}
        , bbox2{}
        {
        }
    ...
    struct IconSpriteAttribute : public Attribute
    {
        ...
        IconSpriteAttribute(std::string const &iconpath)
        : iconpath{iconpath}
        {
        }
    ...
    struct StudioAttribute : public Attribute
    {
        ...
        virtual std::string inner() const override { return '"' + path + '"'; }

        StudioAttribute(std::string const &path)
        : path{path}
        {
        }
