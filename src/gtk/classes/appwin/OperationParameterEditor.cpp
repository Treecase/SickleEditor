...
public:
    ...
    void set_value(lua_Number value) { set_text(std::to_string(value)); }
...
public:
    ...
    void set_value(std::string const &value) { set_text(value); }
...
public:
    ...
    {
        _texture_selector_btn.signal_clicked().connect(sigc::mem_fun(
            *this,
    ...
    void set_value(std::string const &value) { _texture.set_text(value); }
